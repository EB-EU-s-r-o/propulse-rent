...
const StripeIcon = () => (
  <div className="w-5 h-5 rounded bg-[#635BFF]/10 flex items-center justify-center">
...
const CashIcon = () => (
  <div className="w-5 h-5 rounded bg-success/10 flex items-center justify-center text-success">
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
